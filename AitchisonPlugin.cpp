...
#include <stdio.h>
#include <stdlib.h>
#include "AitchisonPlugin.h"

void AitchisonPlugin::input(std::string file) {
 inputfile = file;
}

void AitchisonPlugin::run() {

}

void AitchisonPlugin::output(std::string file) {
...
PluginProxy<AitchisonPlugin> AitchisonPluginProxy = PluginProxy<AitchisonPlugin>("Aitchison", PluginManager::getInstance());
